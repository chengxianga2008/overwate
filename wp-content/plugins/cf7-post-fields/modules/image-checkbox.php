    ...
    class wpcf7_post_fields_image_checkbox extends wpcf7_post_fields_module
    {
        ...
        public function wpcf7_add_form_tag_post_image_checkbox()
        {
            if (function_exists('wpcf7_add_form_tag')) {
                wpcf7_add_form_tag(array('post_image_checkbox', 'post_image_checkbox*', 'post_image_radio'), array($this, 'wpcf7_post_image_checkbox_shortcode_handler'), true);
            }
        }
        ...
        public function wpcf7_post_image_checkbox_shortcode_handler( $tag )
        {
            ...
            foreach ( $values as $key => $value )
            {
                ...
                if(get_post_status($ids[$key]) !== false)
                {
                    ...
                    $image_html = has_post_thumbnail($post->ID) ? get_the_post_thumbnail($post->ID, $image_size) : '<div style="width:'.$image_width.'px; height:'.$image_width.'px; font-size:'.$image_width.'px;" class="wp-post-image dashicons dashicons-format-image"></div>';
