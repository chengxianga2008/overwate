...
var wpAjaxUrl='https://overwaterbungalows.com.au/wp-admin/admin-ajax.php';var flBuilderUrl='https://overwaterbungalows.com.au/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://overwaterbungalows.com.au/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://overwaterbungalows.com.au/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-59719483211ba .pp-heading-separator, .fl-node-59719483211ba .pp-heading').removeClass('pp-center');$('.fl-node-59719483211ba .pp-heading-separator, .fl-node-59719483211ba .pp-heading').addClass('pp-tablet-center');}
if($(window).width()<=480){$('.fl-node-59719483211ba .pp-heading-separator, .fl-node-59719483211ba .pp-heading').removeClass('pp-center');$('.fl-node-59719483211ba .pp-heading-separator, .fl-node-59719483211ba .pp-heading').addClass('pp-mobile-center');}})(jQuery);;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();