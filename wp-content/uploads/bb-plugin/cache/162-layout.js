...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-596dac274218e .pp-heading-separator, .fl-node-596dac274218e .pp-heading').removeClass('pp-left');$('.fl-node-596dac274218e .pp-heading-separator, .fl-node-596dac274218e .pp-heading').addClass('pp-tablet-center');}
if($(window).width()<=480){$('.fl-node-596dac274218e .pp-heading-separator, .fl-node-596dac274218e .pp-heading').removeClass('pp-left');$('.fl-node-596dac274218e .pp-heading-separator, .fl-node-596dac274218e .pp-heading').addClass('pp-mobile-center');}})(jQuery);