...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-596deaa99f01f .pp-heading-separator, .fl-node-596deaa99f01f .pp-heading').removeClass('pp-left');$('.fl-node-596deaa99f01f .pp-heading-separator, .fl-node-596deaa99f01f .pp-heading').addClass('pp-tablet-center');}
if($(window).width()<=480){$('.fl-node-596deaa99f01f .pp-heading-separator, .fl-node-596deaa99f01f .pp-heading').removeClass('pp-left');$('.fl-node-596deaa99f01f .pp-heading-separator, .fl-node-596deaa99f01f .pp-heading').addClass('pp-mobile-center');}})(jQuery);