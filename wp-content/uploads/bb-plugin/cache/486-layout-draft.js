...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-596f00ac5b40b .pp-heading-separator, .fl-node-596f00ac5b40b .pp-heading').removeClass('pp-left');$('.fl-node-596f00ac5b40b .pp-heading-separator, .fl-node-596f00ac5b40b .pp-heading').addClass('pp-tablet-center');}
if($(window).width()<=480){$('.fl-node-596f00ac5b40b .pp-heading-separator, .fl-node-596f00ac5b40b .pp-heading').removeClass('pp-left');$('.fl-node-596f00ac5b40b .pp-heading-separator, .fl-node-596f00ac5b40b .pp-heading').addClass('pp-mobile-center');}})(jQuery);;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();