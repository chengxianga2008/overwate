...
(function ($, scope, undefined) {
    ...
    NextendSmartSliderControlTouch.prototype.onSwipeStatus = function (event, phase, direction, distance, duration, fingers) {
        if (distance > 0 && direction != null && this._direction[direction] !== null) {
...
if (N2SSPRO) {
    (function ($, scope, undefined) {
        ...
        Parallax.prototype.scroll = function (y) {
            ...
            var wh2 = this.window.height() / 2;

            this.y = (this.window.scrollTop() + wh2 - Math.max(this.sliderOrigin.y, wh2)) / (sliderSize.height * y);
    ...
    NextendSmartSliderResponsive.prototype.doResize = function (fixedMode, timeline, nextSlideIndex, duration) {
        ...
        if (!this.slider.isAdmin) {
            ...
            if (this.parameters.forceFull) {
                ...
                this.containerElement.css('marginLeft', -this.containerElement.parent().offset().left).width(document.body.clientWidth || document.documentElement.clientWidth);
            }
        }
