...
(function ($, scope) {
    ...
    NextendSmartSliderCreateSlider.prototype.showDemoSliders = function () {
        ...
        var frame = $('<iframe src="http://smartslider3.com/demo-import/?pro=' + (N2SSPRO ? '1' : '0') + '" frameborder="0"></iframe>').css({
                position: 'fixed',
                zIndex: 10000,
                left: 0,
                top: 0,
            ...
            listener = function (e) {
                if (e.origin !== "http://smartslider3.com")
                    return;
                var msg = e.data;
                switch (msg.key) {
                    case 'importSlider':
...
(function (smartSlider, $, scope, undefined) {
    ...
    Layer.prototype._renderModeProperties = function () {
...
//</editor-fold>
    ...
    AdminSlideLayerManager.prototype.loadData = function (data, overwrite) {
        ...
        for (var i = 0; i < layers.length; i++) {
            ...
            layer.css('zIndex', layer.css('zIndex') + zIndexOffset);
            if (layerData.id) {
                var id = $.fn.uid();
